...
<div style="display:block; ">
    <h1 class="mt-3">التعديل على الخدمة</h1>
</div>
        ...
        <form action="{{ route('services.update', $service->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" required name="name_ar" value="{{$service->name_ar}}" placeholder="الاسم باللغة العربية" class="form-control"
                            id="inputEmail3">
                            @error('name_ar')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" required placeholder="الاسم باللغة الانجليزية" value="{{$service->name_en}}"  name="name_en" class="form-control"
                            id="inputEmail3">
                            @error('name_en')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea type="text" required placeholder="الوصف باللغة العربية" name="description_ar" class="form-control"
                            id="inputEmail3">{{$service->description_ar}}</textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea type="text" required placeholder="الوصف باللغة الانجليزية"  name="description_en" class="form-control"
                            id="inputEmail3">{{$service->description_en}}</textarea>
