...
<div style="display:block; ">
    <h1 class="mt-3">التعديل على القسم</h1>
</div>
        ...
        <form action="{{ route('categories.update', $categories->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="name_ar" value="{{$categories->name_ar}}" placeholder="الاسم باللغة العربية" class="form-control"
                            id="inputEmail3">
                            @error('name_ar')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" placeholder="الاسم باللغة الانجليزية" value="{{$categories->name_en}}"  name="name_en" class="form-control"
                            id="inputEmail3">
                            @error('name_en')
