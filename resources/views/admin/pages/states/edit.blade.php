...
<div style="display:block; ">
    <h1 class="mt-3">التعديل على المحافظة</h1>
</div>
        ...
        <form action="{{ route('states.update', $state->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="name_ar" value="{{$state->name_ar}}" placeholder="الاسم باللغة العربية" class="form-control"
                            id="inputEmail3">
                            @error('name_ar')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" placeholder="الاسم باللغة الانجليزية" value="{{$state->name_en}}"  name="name_en" class="form-control"
                            id="inputEmail3">
                            @error('name_en')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select name="countries" class="form-control" id="">
                            <option disabled value="{{$state->country_id}}">
                                {{$countries[0]->name_ar}} - {{$countries[0]->name_en}}
                            </option>
