...
<div style="display:block; margin-top: 30px">
    <h1>الانواع</h1>
    <a href="{{route('types.create')}}" class="btn btn-primary mt-5">
        <i class="ion ion-plus"></i> اضافة نوع
    </a>
</div>
            ...
            @foreach ($types as $item)
                <tr data-widget="expandable-table" aria-expanded="false">
                    ...
                    <td>
                        ...
                        <form action="{{route('types.destroy', $item->id)}}" class="d-inline-block"  method="post">
                            @csrf
                            @method('DELETE')
