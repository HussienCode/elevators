...
<div style="display:block; ">
    <h1 class="mt-3">التعديل على الدولة</h1>
</div>
        ...
        <form action="{{ route('countries.update', $countries->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="name_ar" value="{{$countries->name_ar}}" placeholder="الاسم باللغة العربية" class="form-control"
                            id="inputEmail3">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" placeholder="الاسم باللغة الانجليزية" value="{{$countries->name_en}}"  name="name_en" class="form-control"
                            id="inputEmail3">
                    </div>
                </div>
