...
<div style="display:block; margin-top: 30px">
    <h1>الدول</h1>
    <a href="{{route('countries.create')}}" class="btn btn-primary mt-5">
        <i class="ion ion-plus"></i> اضافة دولة
    </a>
</div>
            ...
            @foreach ($countries as $item)
                <tr data-widget="expandable-table" aria-expanded="false">
                    ...
                    <td>
                        ...
                        <form action="{{route('countries.destroy', $item->id)}}" class="d-inline-block"  method="post">
                            @csrf
                            @method('DELETE')
