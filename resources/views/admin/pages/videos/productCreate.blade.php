...
<div style="display:block; ">
    <h1 class="mt-3">اضافة فيديو تابع للمنتج</h1>
</div>
    ...
    <div class="card card-info col-12 mt-5">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form action="{{ route('videos.store', ['product_id' => $id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">الفيديو</label>
                    <div class="col-sm-10">
                        <input type="file" required name="productVideos"  class="form-control" id="inputEmail3">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea required name="description_ar" placeholder="وصف الفيديو" class="form-control"></textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">وصف الفيديو الانجليزي</label>
                    <div class="col-sm-10">
                        <textarea required name="description_en" placeholder="description video" class="form-control"></textarea>
                    </div>
                </div>
