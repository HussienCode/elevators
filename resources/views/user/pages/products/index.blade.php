...
@section('content')
    <div class="allProducts">
        <div class="container">
            ...
            <form class="row mb-5 text-center" action="{{ route('webProducts.store', ['cat_id' => $category->id]) }}"
                ...
                <div class="col-md-2 col-sm-12">
                    <input type="text" class="filter-input" placeholder="{{__('message.price')}}" id="validation8" name="price">
                </div>
